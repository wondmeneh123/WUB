    ...
    <div className="bg-white min-h-full">
      ...
      <div className="px-4 pb-20">
        ...
        <img
          src={item.image}
          alt={item.name}
          className="w-full h-80 object-cover rounded-lg my-4 shadow-md"
        />
      ...
      {/* fixed bottom-20 places it above the BottomNavigation bar */}
      <div className="fixed bottom-20 left-0 right-0 p-4 z-40">
        <button className="w-full bg-[#d43790] text-white py-3 rounded-full shadow-lg hover:bg-pink-700 transition-colors font-bold text-lg">
          Add to Cart
        </button>
      </div>
    </div>
